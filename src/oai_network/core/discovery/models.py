...
class DiscoveryResult(BaseModel):
    ...
    agent_description: str = Field(..., description="Agent's description")
    matched_capability: str = Field(..., description="Name of matched capability")
    capability_type: str = Field(..., description="Type of matched capability")
...
class RegistryEntry(BaseModel):
    ...
    agent_did: str = Field(..., description="Agent's DID")
    manifest_json: str = Field(..., description="Full manifest as JSON")
    manifest_hash: str = Field(..., description="Hash of manifest for change detection")
...
class RegistrationRequest(BaseModel):
    ...
    manifest: str = Field(..., description="Agent manifest as JSON")
    proof: str = Field(..., description="Identity proof as JSON")
